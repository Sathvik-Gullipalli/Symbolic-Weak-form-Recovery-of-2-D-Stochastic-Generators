...
# reproduce_all.py
# ─────────────────────────────────────────────────────────────────────────────
# End-to-end runner: runs the three SDE experiments, generates all figures
# with standalone scripts (Figs 1–5), and prints Table 1.
#
# Figures 6–9 (endogeneity, CLT rates, hyperparameter sweep, bias correction)
# are generated by the notebook weak_sindy_figures.ipynb, which also covers
# all of the above. Run the notebook for a single end-to-end pipeline.
#
# Usage:
#   python reproduce_all.py           # full run (~35-55 min total)
...
print("(Figures 6–9 are generated by the notebook: weak_sindy_figures.ipynb)")
print("=" * 70)
...
print("=" * 70)
print("  results/fig1_recovered_vs_true.pdf")
print("  results/fig2_lasso_paths.pdf")
print("  results/fig3_stationary_density.pdf")
print("  results/fig4_autocorr.pdf")
print("  results/fig5_noise_scaling.pdf")
print("  results/table1.txt")
print("  results/run_cache.pkl")
print()
print("Run the notebook for Figures 6–9:")
print("  jupyter notebook weak_sindy_figures.ipynb")
